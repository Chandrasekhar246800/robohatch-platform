...
import { formatPrice, getEffectiveProductPrice, getOriginalProductPrice } from '@/lib/utils';
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 md:p-8">
              <div className="flex items-center mb-4 sm:mb-6">
                ...
                <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-gray-900">Shipping Address</h2>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-9 sm:pl-10 pr-4 py-2.5 sm:py-3 text-sm sm:text-base border rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent ${
                ...
                {/* Street Address */}
                <div>
                  <label htmlFor="addressLine1" className="block text-xs sm:text-sm font-medium text-gray-700 mb-1.5 sm:mb-2">
                  ...
                  />
                  {errors.addressLine1 && (
                    <p className="mt-1 text-xs sm:text-sm text-red-500">{errors.addressLine1}</p>
                  )}
                </div>

                {/* Address Line 2 (Optional) */}
                <div>
                  <label htmlFor="addressLine2" className="block text-xs sm:text-sm font-medium text-gray-700 mb-1.5 sm:mb-2">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full px-3 sm:px-4 py-2.5 sm:py-3 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
                ...
                <div className="grid md:grid-cols-3 gap-4 sm:gap-6">
                  ...
                  <div>
                    <label htmlFor="state" className="block text-xs sm:text-sm font-medium text-gray-700 mb-1.5 sm:mb-2">
                  ...
                  <div>
                    <label htmlFor="postalCode" className="block text-xs sm:text-sm font-medium text-gray-700 mb-1.5 sm:mb-2">
                    ...
                    />
                    {errors.postalCode && (
                      <p className="mt-1 text-xs sm:text-sm text-red-500">{errors.postalCode}</p>
                    )}
                  </div>
                </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 lg:sticky lg:top-6">
              ...
              <div className="space-y-2 sm:space-y-3 mb-3 sm:mb-4">
                ...
                {items.length > 3 && (
                  <p className="text-xs sm:text-sm text-gray-600">+ {items.length - 3} more items</p>
                )}
              </div>
              ...
              <div className="border-t pt-3 sm:pt-4 space-y-1.5 sm:space-y-2">
                ...
                <div className="flex justify-between text-lg sm:text-xl font-bold text-gray-900 pt-1.5 sm:pt-2 border-t">
                  <span>Total</span>
