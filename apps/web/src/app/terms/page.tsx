    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <section className="mb-8 bg-white rounded-lg shadow-md p-8">
          ...
          <p className="text-gray-700 mb-4">
            All prices are listed in Indian Rupees (INR). We reserve the right to change prices at any time without prior notice. Price changes will not affect orders already placed.
          </p>
