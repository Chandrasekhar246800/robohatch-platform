...
export const e2eEnv: E2EEnv = {
  ...
  customerEmail: readEnv('E2E_TEST_USER_EMAIL', 'e2e.customer@robohatch.local'),
  customerPassword: readEnv('E2E_TEST_USER_PASSWORD', 'E2E_test_pass_2026!'),
  adminEmail: readEnv('E2E_ADMIN_EMAIL', 'e2e.admin@robohatch.local'),
  adminPassword: readEnv('E2E_ADMIN_PASSWORD', 'E2E_admin_pass_2026!'),
