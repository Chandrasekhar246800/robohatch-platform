...
- Name: apps\web\e2e\cro-validation.spec.ts >> visual regression protection mobile >> mobile snapshot protects sticky CTAs
- Location: apps\web\e2e\cro-validation.spec.ts:271:7
