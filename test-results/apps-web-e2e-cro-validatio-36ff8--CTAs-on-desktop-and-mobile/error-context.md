...
- Name: apps\web\e2e\cro-validation.spec.ts >> conversion flow reliability >> trust visibility renders near purchase CTAs on desktop and mobile
- Location: apps\web\e2e\cro-validation.spec.ts:195:7
