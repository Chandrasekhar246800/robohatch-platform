...
- Name: apps\web\e2e\cro-validation.spec.ts >> mobile conversion UX >> sticky cart CTA remains accessible while scrolling
- Location: apps\web\e2e\cro-validation.spec.ts:222:7
