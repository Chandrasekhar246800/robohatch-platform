...
- Name: apps\web\e2e\cro-validation.spec.ts >> visual regression protection >> desktop PDP snapshot protects trust row and CTA hierarchy
- Location: apps\web\e2e\cro-validation.spec.ts:234:7
