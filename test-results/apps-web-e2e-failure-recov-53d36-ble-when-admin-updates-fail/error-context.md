...
- Name: apps\web\e2e\failure-recovery.spec.ts >> failure recovery >> rollback safety is visible when admin updates fail
- Location: apps\web\e2e\failure-recovery.spec.ts:19:7
