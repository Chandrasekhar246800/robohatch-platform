...
- Name: apps\web\e2e\cro-validation.spec.ts >> visual regression protection >> checkout snapshot protects guest checkout and form hierarchy
- Location: apps\web\e2e\cro-validation.spec.ts:253:7
