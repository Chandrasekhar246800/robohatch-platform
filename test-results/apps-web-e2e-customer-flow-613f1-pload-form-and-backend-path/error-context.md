...
- Name: apps\web\e2e\customer-flow.spec.ts >> customer flows >> upload-design validates the upload form and backend path
- Location: apps\web\e2e\customer-flow.spec.ts:45:7
