...
- Name: apps\web\e2e\cro-validation.spec.ts >> mobile conversion UX >> sticky PDP CTA stays accessible while scrolling
- Location: apps\web\e2e\cro-validation.spec.ts:212:7
