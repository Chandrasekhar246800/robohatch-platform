...
- Name: apps\web\e2e\admin-cockpit.spec.ts >> admin and founder cockpit >> bulk toolbar and selection remain wired
- Location: apps\web\e2e\admin-cockpit.spec.ts:25:7
