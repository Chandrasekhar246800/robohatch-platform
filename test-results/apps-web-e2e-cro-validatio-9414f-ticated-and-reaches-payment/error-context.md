...
- Name: apps\web\e2e\cro-validation.spec.ts >> conversion flow reliability >> guest checkout stays unauthenticated and reaches payment
- Location: apps\web\e2e\cro-validation.spec.ts:158:7
