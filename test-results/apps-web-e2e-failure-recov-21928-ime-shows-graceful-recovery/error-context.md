...
- Name: apps\web\e2e\failure-recovery.spec.ts >> failure recovery >> api downtime shows graceful recovery
- Location: apps\web\e2e\failure-recovery.spec.ts:4:7
...
Locator: getByText(/failed to load products|discover our complete collection/i)
Expected: visible
Timeout: 20000ms
...
Call log:
  ...
  - waiting for getByText(/failed to load products|discover our complete collection/i)
