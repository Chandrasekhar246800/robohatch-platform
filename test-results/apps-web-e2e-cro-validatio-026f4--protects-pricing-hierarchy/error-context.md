...
- Name: apps\web\e2e\cro-validation.spec.ts >> visual regression protection >> cart snapshot protects pricing hierarchy
- Location: apps\web\e2e\cro-validation.spec.ts:243:7
